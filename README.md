# 苏格拉底式启发教学 Agent 👉 [在线查看 AI 产品经理作品集](./index.html)
...
- 打开 `index.html` 查看在线作品集
- 打开 `AI产品经理作品集_苏格拉底式启发教学Agent.pdf` 查看 PDF 版本

### 2. 本地预览（推荐）

如果希望在浏览器中本地预览，可在项目目录运行：
...
该仓库主要用于展示 **AI 产品经理作品集** 与 **Agent 工作流设计思路**。

如果从简历或作品集链接进入，建议优先查看：

- `index.html`：在线作品集
- `AI产品经理作品集_苏格拉底式启发教学Agent.pdf`：PDF 版本
